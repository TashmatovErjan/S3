package et.oss.exceptions.advice;

import et.oss.exceptions.AccountTypeNotFoundException;
import et.oss.exceptions.InvalidUserTypeException;
...
public class GlobalControllerAdvice {
    ...
    public String handleInvalidUserType(InvalidUserTypeException e,
                                        HttpServletRequest request, Model model) {
        log.error("Ошибка типа пользователя: {}", e.getMessage());
        prepareErrorModel(model, HttpStatus.BAD_REQUEST, request);
    ...
    public String accountTypeNotFoundException(
            HttpServletRequest request,
            Model model) {
